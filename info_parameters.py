help_dic = {
    ...
    "segmentObject_Labels_aeraMax": "Maximum size of the segmented DAPI mask\n\nDefault Value = 3000",
    "segmentObject_Labels_aeraMin": "Minimum size of the segmented DAPI mask\n\nDefault Value = 150",
...
default_Entry_dic={
    ...
    "rna_ch": "ch01",
    "rnaFid_ch": "ch00",
    "pixelSizeXY_Entry": 0.1,
    "pixelSizeZ_Entry": 0.25,
    "blockSize_Entry": 256,
    "referenceFiducial_Entry": "RT1",
    "flux_min_Entry": 10,
    "flux_min_3D_Entry": 4000,
    "toleranceDrift_Entry": 1,
    "mask_expansion_Entry": 8,
    "masks2process_Entry": "nuclei:DAPI, mask1:mask1",
    "folder_Entry": "buildsPWDmatrix",
    "tracing_method_Entry": "masking,clustering",
    "KDtree_distance_threshold_mum_Entry": 1,
    "stardist_Entry": "/mnt/grey/DATA/users/marcnol/pyHiM_AI_models/networks",
    "brightest_Entry": 1100,
    "aeraMaxSegObjt_Entry": 3000,
    "aeraMinSegObjt_Entry": 10,
    "zProject_Dapi_zmax_Entry": 59,
    "zProject_Dapi_zmin_Entry": 1,
    "zmaxZProjct_Bcd_Entry": 59,
    "zminZProjct_Bcd_Entry": 1,
    "zmaxZProjct_Mask_Entry": 59,
    "zminZProjct_Mask_Entry": 1,
}
